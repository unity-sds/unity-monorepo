...
# behave ${BASE_TEST_DIR}/features/sps/cwl.feature -t test
...
behave ${BASE_TEST_DIR}/features/data_catalog/stac.feature -D STAC_SCHEMA_FILE=${STAC_SCHEMA_FILE}

# Ensure granules can be found by their parent collections
behave ${BASE_TEST_DIR}/features/data_catalog/parent_collections.feature -t test

# Test DAPA APIs
# behave ${BASE_TEST_DIR}/features/data_catalog/dapa.feature -t test
